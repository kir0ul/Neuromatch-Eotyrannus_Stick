...
# %% colab={"base_uri": "https://localhost:8080/"} id="LhgjweX--FNI" outputId="d90bc224-6f4e-47fb-9b21-497f8a51795d"
...
from tqdm.auto smuggle tqdm
from IPython.display import display
import warnings

# DL
smuggle torch
smuggle torch.nn.functional as F
...
# %% colab={"base_uri": "https://localhost:8080/"} id="uBqTnSQil9aQ" outputId="15a8503d-6208-43fb-bd2c-18485234a8aa"
SEED = 2021
set_seed(seed=SEED)
...
# %% colab={"base_uri": "https://localhost:8080/"} id="YrHL1Bj0l2Og" outputId="61dfa872-7a4d-4ce8-9d6d-2d8f72bd1206"
device = set_device()

# %% colab={"base_uri": "https://localhost:8080/"} id="3PEdG7udljP6" outputId="a4eabc1f-c5e1-455a-ae5e-9e42e75a8bc4"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 540} id="Rj8Z7v4mlqc3" outputId="74918cdf-58dc-41ba-834d-8874929b1781"
...
# %% colab={"base_uri": "https://localhost:8080/"} id="nHcNOTSZmAdi" outputId="60fa4794-f4a5-4c36-e3e5-91c57f138764"
# Get all the subject IDs from NYU
# subject_list = Phenotypic_V1_0b_dat[Phenotypic_V1_0b_dat.SITE_ID == "NYU"].SUB_ID
subject_list = Phenotypic_V1_0b_dat.SUB_ID
subject_list
...
# %% colab={"base_uri": "https://localhost:8080/"} id="0Cmj1YOWA31M" outputId="37915c4b-ef70-429d-f0e7-94580c055d90"
print(abide.keys())

# %% colab={"base_uri": "https://localhost:8080/"} id="-fDQPMrPOC8E" outputId="7d60fe85-1a3d-48fe-bb0e-c4d4bcb2a968"
len(abide.rois_cc200)

# %% colab={"base_uri": "https://localhost:8080/", "height": 505} id="h_PZyg-6Iaa2" outputId="7f5f7887-c576-489a-bcf4-cfaf7e1e7c86"
phen_abide = abide['phenotypic']
phen_abide

# %% colab={"base_uri": "https://localhost:8080/", "height": 300} id="p21oUS4QWukl" outputId="bbb8bae4-e84f-48ac-bb95-f0d0c06ff8cd"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 300} id="qmdoMymzYvYT" outputId="9e01ae63-1e9c-48a8-db8b-13d1da247d41"
males_stat = inf_descrip.loc[inf_descrip['SEX'] == 1]
males_stat.describe()

# %% colab={"base_uri": "https://localhost:8080/", "height": 300} id="m-wW0qUzZHjC" outputId="5b672e35-d2d9-41b4-ab01-9ab649c814fd"
...
# %% colab={"base_uri": "https://localhost:8080/"} id="6gKzCenzUBWb" outputId="ae0d379f-d64b-4d9f-9964-142e3ea2127e"
# x_data = np.asarray(abide['rois_cc200'])
# x_data.shape # 160 subjects, 176 time series, 200 ROIs

# %% colab={"base_uri": "https://localhost:8080/"} id="rE5BEkYkVD9X" outputId="45064a2d-3af0-473e-a277-b2360f305b1d"
...
# %% colab={"base_uri": "https://localhost:8080/"} id="4SJenYtKUOK4" outputId="5e1e035c-a0fe-4c09-fb83-354f9bc92ff3"
y_target = replace_values(y_target)
print(y_target, len(y_target))

# %% colab={"base_uri": "https://localhost:8080/", "height": 35} id="NYjeAePJnnco" outputId="7a178063-de77-45c4-fbe7-618abf80bbe1"
abide['func_preproc'][0]

# %% colab={"base_uri": "https://localhost:8080/"} id="BWJn9h1vFYbV" outputId="31dc2c7a-0efd-45a7-b8f4-6262e5164063"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 447} id="L5Ty0o-tuE1i" outputId="c053db39-7397-4e85-da1b-65cd1a47867e"
...
# %% colab={"base_uri": "https://localhost:8080/"} id="GOVq6vv6I8TR" outputId="6063612a-2210-4927-9624-8d8ca9e1b388"
print(X_test.shape, y_test.shape, X_train.shape, y_train.shape)

# %% colab={"base_uri": "https://localhost:8080/"} id="OxaOXRvpI6Gz" outputId="49820776-775d-497c-ddf6-011dd34fdc09"
print(train_loader)
...
# %% colab={"base_uri": "https://localhost:8080/"} id="yu4QnXn38Cti" outputId="eccaa039-22d7-43fa-a544-eb5e761db7ea"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 533, "referenced_widgets": ["47d8a3c5c5074dbd8570083cb4cfac00", "64eae828a1b24c37afa1901997a9346e", "90f7260d217e48a8ba43a343e45fab39", "66eb0b9220b94bada52a78eaeef476dd", "3e3bd0301d3d4d818345ea1f8e6908fe", "4b45346824944c22b7c060f0c9d38f38", "4767e575c4e646f690e9d4ed51688490", "bab787da170d4ea48531a02be4998872", "b715552160084a27bcb6711b67908fae", "d3ebd94c787e4650b5a56992798d2cec", "5a905c3f6f8d4e1a9e35137809bc2963"]} id="zjcET8upo3Hn" outputId="87a6db81-b1d4-4297-96fe-0b619a352cc8"
set_seed(SEED)
